...
export function parseContacts(contacts: ContactContacts | string): ContactContacts {
...
export function parseEvents(events: ContactEvents | string | undefined): ContactEvents | undefined {
